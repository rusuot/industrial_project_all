// Files from Components are very similar depending on product category, with small differences 
                    ...
                    <div className="card-data">
                      ...
                      <div className="category-rating">
                        ...
                        <div className="rating">
                          <img src={rating} className="rating-img" alt=""/>
                          <img src={rating} className="rating-img" alt=""/>
                          <img src={rating} className="rating-img" alt=""/>
                          <img src={rating} className="rating-img" alt=""/>
                          <img src={rating} className="rating-img" alt=""/>
